select theday, experimenttypename, experimentmodename, experimentmodeid, isdesktop, culturekey, sum(completedcheckout30m) as completedcheckout30m, sum(qp6h) as qp6h, sum(sco30m) as sco30m, sum(trial) as trial from
(
select
...
group by theday, experimenttypename, experimentmodename, experimentmodeid, isdesktop, culturekey
